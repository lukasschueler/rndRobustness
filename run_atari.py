...
def main():
    ...
    parser.add_argument('--num-timesteps', type=int, default=int(100000000))
    ...
    wandb.init(project="thesis", group = "Random_Network_Distillation", entity = "lukischueler", name = "Extrinsic", config = hps)
